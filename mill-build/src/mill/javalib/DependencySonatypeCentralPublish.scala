...
/** [[SonatypeCentralPublisher2]], minus the checksums of the PGP signatures.
  ...
  * ([[https://github.com/com-lihaoyi/mill/blob/1.1.8/libs/javalib/src/mill/javalib/publish/SonatypeHelpers.scala#L211-L241]]) -
...
/** Publishes to Sonatype Central the way `mill.javalib.SonatypeCentralPublishModule` does, but
  ...
  * `SonatypeCentralPublishModule.publishAll`, as of Mill 1.1.8:
  *   - [[https://github.com/com-lihaoyi/mill/blob/1.1.8/libs/javalib/src/mill/javalib/SonatypeCentralPublishModule.scala#L108-L150 the command]]
  *   - [[https://github.com/com-lihaoyi/mill/blob/1.1.8/libs/javalib/src/mill/javalib/SonatypeCentralPublishModule.scala#L152-L244 the logic it delegates to]]
  *
  * THIS FILE IS TEMPORARY. The signature checksums are a Mill bug rather than something this build
  ...
  * dependency from the `build.mill` header, take `DependencySonatypeCentralPublish` back off
  * `object ci`, and point `.github/workflows/ci.yml` at
  * `mill.scalalib.SonatypeCentralPublishModule/` again.
  */
trait DependencySonatypeCentralPublish extends MavenWorkerSupport, PgpWorkerSupport, MavenPublish {
